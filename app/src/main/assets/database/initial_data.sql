...
CREATE TABLE IF NOT EXISTS "TrainingPlan" (
	...
	"isFinished"	INTEGER NOT NULL DEFAULT 0 CHECK("isFinished" IN (0, 1)),
...
CREATE TABLE IF NOT EXISTS "Notification" (
	...
	"notiRunSessionId"	INTEGER,
	"title"	TEXT NOT NULL,
	"message"	TEXT NOT NULL,
	"timeTriggred"	TEXT NOT NULL,
	"notificationType"	TEXT NOT NULL,
	PRIMARY KEY("notificationId" AUTOINCREMENT),
	FOREIGN KEY("notiRunSessionId") REFERENCES "RunSession"("sessionId") ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS "index_Notification_notiRunSessionId" ON "Notification" (
	"notiRunSessionId"
);
